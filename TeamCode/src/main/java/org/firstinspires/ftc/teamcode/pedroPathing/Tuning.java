 ...
 *
 * <p>Deploy this code, connect to the robot's Wi-Fi and open http://192.168.43.1:10158 in a browser
 * to run them (see https://pedropathing.com/docs/pathing/tuning). Paste the configs that AutoTune
 * generates into {@link Constants}.
 *
 * <p>The tuners below assume a mecanum drivetrain with a goBILDA Pinpoint. If your robot differs,
 * swap in the matching tuner and localizer/drivetrain from the procedures package (e.g. {@code
 * OTOSTuner}, {@code ThreeWheelTuner}, {@code TwoWheelTuner}, {@code OctoQuadTuner}).
 */
public class Tuning {
  @Tuner
